...
document.querySelectorAll('.family-reveal').forEach((el) => {
  io.observe(el);
});
...
document.querySelectorAll('[data-slider]').forEach((slider) => {
  ...
  const slides = [
    ...slider.querySelectorAll('.family-hero-slide')
  ];
...
const familyFilterButtons = document.querySelectorAll(".family-family-filter-btn");
const familyGalleryItems = document.querySelectorAll(".family-family-filter-item");
