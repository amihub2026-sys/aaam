...
document.querySelectorAll('.stalls-reveal').forEach((el) => {
  io.observe(el);
});
...
document.querySelectorAll('[data-slider]').forEach((slider) => {
  ...
  const slides = [
    ...slider.querySelectorAll('.stalls-hero-slide')
  ];

  const dots = [
    ...slider.parentElement.querySelectorAll(
      '.stalls-slider-dots button'
    )
  ];
...
const stallsFilterButtons = document.querySelectorAll(".stalls-stalls-filter-btn");
const stallsGalleryItems = document.querySelectorAll(".stalls-stalls-filter-item");
