/* Page interactions: entertainment */
/* Reveal animation */
...
document.querySelectorAll('.entertainment-reveal').forEach((el) => {
  io.observe(el);
});
...
document.querySelectorAll('[data-slider]').forEach((slider) => {
  ...
  const slides = [
    ...slider.querySelectorAll('.entertainment-hero-slide')
  ];

  const dots = [
    ...slider.parentElement.querySelectorAll(
      '.entertainment-slider-dots button'
    )
  ];
...
const entertainmentFilterButtons = document.querySelectorAll(
  ".entertainment-entertainment-filter-btn"
);

const entertainmentGalleryItems = document.querySelectorAll(
  ".entertainment-entertainment-filter-item"
);
