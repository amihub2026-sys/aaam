...
document.querySelectorAll('.decoration-reveal').forEach((el) => {
  io.observe(el);
});
...
document.querySelectorAll('[data-slider]').forEach((slider) => {
  ...
  const slides = [
    ...slider.querySelectorAll('.decoration-hero-slide')
  ];

  const dots = [
    ...slider.parentElement.querySelectorAll(
      '.decoration-slider-dots button'
    )
  ];
...
const decorationFilterButtons = document.querySelectorAll(
  ".decoration-decoration-filter-btn"
);

const decorationGalleryItems = document.querySelectorAll(
  ".decoration-decoration-filter-item"
);
