...
document.querySelectorAll('.photography-reveal').forEach((el) => {
  io.observe(el);
});
...
const photographyFilterButtons = document.querySelectorAll(
  ".photography-photography-filter-btn"
);

const photographyGalleryItems = document.querySelectorAll(
  ".photography-photography-filter-item"
);
