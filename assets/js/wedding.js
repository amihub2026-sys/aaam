...
document.querySelectorAll('.wedding-reveal').forEach((el) => {
  io.observe(el);
});
...
document.querySelectorAll('[data-slider]').forEach((slider) => {
  ...
  const slides = [
    ...slider.querySelectorAll('.wedding-hero-slide')
  ];
...
const weddingFilterButtons = document.querySelectorAll(".wedding-wedding-filter-btn");
const weddingGalleryItems = document.querySelectorAll(".wedding-wedding-filter-item");
