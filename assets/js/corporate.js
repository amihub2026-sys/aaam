...
document.querySelectorAll('.corporate-reveal').forEach((el) => {
  io.observe(el);
});
...
document.querySelectorAll('[data-slider]').forEach((slider) => {
  ...
  const slides = [
    ...slider.querySelectorAll('.corporate-hero-slide')
  ];

  const dots = [
    ...slider.parentElement.querySelectorAll(
      '.corporate-slider-dots button'
    )
  ];
...
const corporateFilterButtons = document.querySelectorAll(".corporate-corporate-filter-btn");
const corporateGalleryItems = document.querySelectorAll(".corporate-corporate-filter-item");
